...
from blogboard.models import Profile
...
#widget is like css so bottstrap understands
class SignUpForm(UserCreationForm):
    ...
    #to bootstrify the username and password1 and pass2
...
#widget is to bootstrapofy our webpage
    class Meta:
        model = User
